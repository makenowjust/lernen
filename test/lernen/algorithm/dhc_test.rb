  ...
  module Algorithm
    class DHCTest < Minitest::Test
      ...
      def test_learn_moore
        ...
        oracle = Equiv::ExhaustiveSearchOracle.new(alphabet, sul)
        hypothesis = DHC.learn(alphabet, sul, oracle, automaton_type: :moore)
      ...
      def test_learn_mealy
        ...
        sul = System.from_block { |word| word.count("1") % 4 }
        oracle = Equiv::ExhaustiveSearchOracle.new(alphabet, sul)
        hypothesis = DHC.learn(alphabet, sul, oracle, automaton_type: :mealy)
